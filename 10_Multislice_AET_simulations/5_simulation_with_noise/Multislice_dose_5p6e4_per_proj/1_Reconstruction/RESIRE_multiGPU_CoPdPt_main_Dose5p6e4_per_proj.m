...
projections = importdata('CoPdPt_Proj_Dose5p6e4_BM3D.mat');
angles      = importdata('CoPdPt_Angle_Dose5p6e4.mat');
%% input
...
%save("Resire_CoPdPt_Dose5p6e4_rec.mat","OBJ",'-v7.3')
%save("Resire_CoPdPt_Dose5p6e4_CalProj.mat","ref_projs",'-v7.3')
...
load('Resire_CoPdPt_Dose5p6e4_CalProj.mat')
load('Proj_Dose5p6e4_PoissonNoise_BeforeBM3D.mat')
%
projections_BM3D=projections;
figure();
img(Proj_Dose5p6e4_PoissonNoise(30:end-30,30:end-30,:),[],projections_BM3D(30:end-30,30:end-30,:),[],ref_projs(30:end-30,30:end-30,:),[],'colormap','gray')
