...
%% Classified atoms
Model=load('Model_CoPdPt_Dose5p6e4.mat');
atoms=Model.temp_model;
atoms_type=Model.temp_atomtype;
ID2=find(atoms_type==1);% Cal. RMSD of specified type of atoms. 1(Co), 2(Pd) 3(Pt)
...
% save('dif_Dose5p6e4_AtomTypeAll.mat','dif')
% save('dif_Dose5p6e4_AtomType1.mat','dif')
% save('dif_Dose5p6e4_AtomType2.mat','dif')
% save('dif_Dose5p6e4_AtomType3.mat','dif')
return
%%
dif_AtomTypeAll=load('dif_Dose5p6e4_AtomTypeAll.mat');
dif_AtomTypeAll=dif_AtomTypeAll.dif;
dif_AtomType1=load('dif_Dose5p6e4_AtomType1.mat');
dif_AtomType1=dif_AtomType1.dif;
dif_AtomType2=load('dif_Dose5p6e4_AtomType2.mat');
dif_AtomType2=dif_AtomType2.dif;
dif_AtomType3=load('dif_Dose5p6e4_AtomType3.mat');
